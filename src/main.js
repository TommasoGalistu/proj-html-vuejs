...
import { faArrowDown, faAngleDown, faChartPie, faUsers, faChartSimple } from '@fortawesome/free-solid-svg-icons';
...
library.add(faArrowDown, faAngleDown, faChartPie, faUsers, faChartSimple);
